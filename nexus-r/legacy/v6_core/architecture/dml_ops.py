"""
SNAP-C1 V6: DirectML-Safe Operations
====================================
Copied from V5 — battle-tested ops that work on AMD RX 7600 via torch-directml.
Every op has been verified: forward + backward, no scatter_ crashes.
